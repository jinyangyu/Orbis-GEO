...
const tourSteps = [
  ...
  { eyebrow: "03 · 竞争排名", title: "知道谁正在赢得 AI 的推荐", copy: "排名结合提及次数、声量份额 与覆盖率，帮助你发现真正的 AI 搜索竞争者。", focus: "ranking" },
...
function BrandLockup() {
  return <div className="onboarding-brand"><div className="brand-orbit"><i /></div><div><strong>ORBIS</strong><span>AI 搜索情报</span></div></div>;
}
